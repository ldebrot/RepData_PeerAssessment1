...
However the total number of steps is clearly higher in the dataset with imputed NA values (`r sum(act_narep_agg_date$x)`) than in the initial dataset (`r sum(act_wona_agg_date$x)`).
